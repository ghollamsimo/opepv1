...
<body>
    <div class="relative text-white mt-16 bg-[#557C55]">
        <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-[#557C55]" preserveAspectRatio="none"
            viewBox="0 0 1440 54">
            ...
            <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
                <div class="md:max-w-md lg:col-span-2">
                    <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">Opep</span>
                    </a>
                ...
                <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                    <div>
                        ...
                        <ul class="mt-2 space-y-2">
                            <li>
                                <a href="./home.php"
                                    class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">Home</a>
                            </li>
                            <li>
                                <a href="./"
                            ...
                            <li>
                                <a href="./plants.php"
                                    class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">Plants</a>
                            </li>
                            <li>
                                <a href="./category"
                                    class="transition-colors duration-300 text-deep-purple-50 hover:text-teal-accent-400">Category</a>
                            </li>
                        </ul>
                    </div>
                    <div>
